...
SRC_URI="https://www.tabos.org/wp-content/uploads/tabos/${PN}-${PV}.tar.xz"

LICENSE="GPL2"
SLOT="0"
KEYWORDS="~x86 ~amd64"
IUSE="appindicator libnotify gnotification ebook gdata kwallet kwallet5 secret gstreamer pulseaudio portaudio faxophone"
